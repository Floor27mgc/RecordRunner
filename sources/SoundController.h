...
#define SOUND_BOMB_INV_PICKUP 4
// --- PLAYER ---
#define SOUND_PLAYER_SWIPE 0
#define SOUND_PLAYER_DIE 1
#define SOUND_PLAYER_START 2
#define SOUND_PLAYER_INV_LEFT 3
#define SOUND_PLAYER_INV_RIGHT 4
#define SOUND_PLAYER_GOT_INV 5
#define SOUND_PLAYER_SCRATCH_LEFT 6
#define SOUND_PLAYER_SCRATCH_RIGHT 7
// --- MENUS ----
